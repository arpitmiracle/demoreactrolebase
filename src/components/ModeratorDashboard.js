              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-group mt-3">
                  ...
                  <select
                    ...
                    {...register("role")}
                  >
                    <option value="user" selected={register.role === "user"} disabled>
                      User
                    </option>
                    <option
                      value="moderator"
                      selected={register.role === "moderator"} disabled
                    >
                      Moderator
                    </option>
                    <option value="admin" selected={register.role === "admin"} disabled>
                      Admin
                    </option>
                  </select>
                </div>
